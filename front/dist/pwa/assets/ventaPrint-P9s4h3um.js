import{n as e,t}from"./empresa-CnkXV6dk.js";var n=e(),r=`
...
.total{font-size:15px}.cancelled{font-size:28px;color:#17406B;text-align:center;font-weight:bold}
`,i=e=>String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`),a=e=>Number(e||0).toFixed(2);function o(e){let o=t(),s=o.logo_url||`${window.location.origin}/glag-logo.png`,c=(e.detalles||[]).map(e=>`<tr><td>${i(e.nombre)}<br><small>${e.unidad===`KG`?Number(e.cantidad).toFixed(3):Number(e.cantidad).toFixed(0)} ${i(e.unidad)} × ${a(e.precio_venta)}</small></td><td class="right">${a(e.total)}</td></tr>`).join(``),l=document.createElement(`div`);l.innerHTML=`<div class="ticket"><img class="logo" src="${s}" alt="GLAG"><h2>${i(o.nombre_empresa||`GLAG`)}</h2><div class="center">${i(o.direccion||``)}<br>Tel: ${i(o.telefono||``)} ${o.nit?`· NIT: ${i(o.nit)}`:``}<br><b>COMPROBANTE DE VENTA</b></div><div class="line"></div>
